export const ACCESS_TOKEN_COOKIE = "__Host-admin-session";
export const REFRESH_TOKEN_COOKIE = "__Host-admin-refresh-session";

export const LEGACY_SESSION_COOKIES = [
  "template.admin-access-token",
  "template.admin-refresh-token",
] as const;
