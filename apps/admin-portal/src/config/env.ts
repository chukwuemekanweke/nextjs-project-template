...
const environment = createBrowserEnvironment(
  browserBrandingEnvironmentSchema.extend({
    NEXT_PUBLIC_ADMIN_PORTAL_DESCRIPTION: z.string().trim().min(1),
  }),
  {
    ...
    NEXT_PUBLIC_ADMIN_PORTAL_DESCRIPTION:
      process.env.NEXT_PUBLIC_ADMIN_PORTAL_DESCRIPTION,
  },
);
...
export const env = Object.freeze({
  ...
  description: environment.NEXT_PUBLIC_ADMIN_PORTAL_DESCRIPTION,
});
